        ...
        overlay.innerHTML = `
            <div style="background:${bg};color:${txt};border:1px solid ${brd};border-radius:16px;padding:28px 32px;max-width:400px;width:90%;box-shadow:0 20px 60px rgba(0,0,0,0.4);animation:scaleIn 0.3s ease;text-align:center;">
                ...
                <div style="display:flex;gap:10px;justify-content:center;">
                    <button id="bskyConfirmNo" style="padding:10px 20px;border-radius:9px;border:1px solid ${brd};background:transparent;color:${txt};font-size:13px;font-weight:600;cursor:pointer;">Annuler</button>
                    <button id="bskyConfirmYes" style="padding:10px 22px;border-radius:9px;border:none;background:linear-gradient(135deg,#EF4444,#F87171);color:white;font-size:13px;font-weight:700;cursor:pointer;">Confirmer</button>
                </div>
            </div>`;
