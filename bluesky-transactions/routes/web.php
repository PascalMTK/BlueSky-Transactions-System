...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::patch('/reports/{report}/reply',       [AgentReportController::class, 'reply'])->name('reports.reply');
    Route::delete('/system/reset',                [AdminController::class, 'resetSystem'])->name('system.reset');
    Route::delete('/system/reset/{country}',      [AdminController::class, 'resetByCountry'])->name('system.reset.country');
