                ...
                <div style="display:flex; gap:16px; align-items:flex-start; margin-bottom:16px;">
                    ...
                    <div style="flex:1;">
                        <div class="form-row cols-2">
                            ...
                            <div class="form-group">
                                <label class="form-label">{{ __('app.flag_emoji') }}
                                    <span style="font-size:10px;color:var(--sky-primary);font-weight:500;margin-left:4px;">
                                        ✨ {{ app()->getLocale() === 'fr' ? 'auto depuis le code' : 'auto from code' }}
                                    </span>
                                </label>
                                ...
                                <div style="font-size:10px;color:var(--text-muted);margin-top:3px;">
                                    {{ app()->getLocale() === 'fr' ? 'Généré automatiquement ou modifiable manuellement' : 'Auto-generated or override manually' }}
                                </div>
                ...
                <div class="form-row cols-2">
                    <div class="form-group">
                        ...
                        <input type="text" name="code" id="countryCode"
                               ...
                               oninput="this.value=this.value.toUpperCase(); autoFillFlag(this.value)" required>
...
function autoFillFlag(code) {
    const flagInput = document.getElementById('flagInput');
    const generated = codeToFlag(code);
    if (generated) {
        flagInput.value = generated;
        updateFlagPreview(generated);
    }
}
