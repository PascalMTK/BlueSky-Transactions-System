...
<div class="stats-grid">
    <div class="stat-card blue animate-on-scroll">
        ...
        <div class="stat-info">
            ...
            <div class="stat-label">{{ app()->getLocale() === 'fr' ? 'Total pays' : 'Total countries' }}</div>
        </div>
    </div>
    ...
    <div class="stat-card gold animate-on-scroll">
        ...
        <div class="stat-info">
            ...
            <div class="stat-label">{{ app()->getLocale() === 'fr' ? 'Devises' : 'Currencies' }}</div>
        </div>
    </div>
        ...
        <div style="padding:18px 18px 16px;">
            ...
            <div style="display:flex; align-items:flex-start; justify-content:space-between; margin-bottom:14px;">
                ...
                <form method="POST" action="{{ route('admin.countries.toggle', $country) }}">
                    ...
                    <button type="submit"
                        ...
                        {{ $country->is_active ? '● '.__('app.active') : '○ '.__('app.disabled') }}
                    </button>
                </form>
            </div>
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; margin-bottom:14px;">
                ...
                <div style="text-align:center; padding:9px; background:var(--bg-input); border-radius:9px;
                    ...
                    <div style="font-size:10px; color:var(--text-muted); margin-top:2px;">Tx</div>
                </div>
            </div>
    ...
    <div style="grid-column:1/-1;">
        <div class="card" style="text-align:center; padding:56px 24px;">
            ...
            <p style="color:var(--text-muted); font-size:13px; margin-bottom:20px;">
                {{ app()->getLocale() === 'fr'
                    ? 'Ajoutez votre premier pays pour commencer.'
