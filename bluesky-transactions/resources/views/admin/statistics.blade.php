...
@section('page-subtitle', 'Annual growth, monthly trends and per-country breakdown')
...
<div class="charts-row" style="margin-bottom:24px;">
    <div class="card animate-on-scroll">
        <div class="card-header">
            <div>
                ...
                <div class="card-subtitle">Volume and transaction count per year</div>
            </div>
        </div>
        <div class="card-body">
    ...
    <div class="card animate-on-scroll">
        <div class="card-header">
            <div>
                <div class="card-title">📅 Monthly — {{ now()->year }}</div>
                <div class="card-subtitle">Monthly progression for this year</div>
            </div>
        </div>
        <div class="card-body">
...
<div class="table-card mb-20 animate-on-scroll">
    ...
    <table class="bsky-table">
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="5" style="text-align:center; padding:40px; color:var(--text-muted)">No data available</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
