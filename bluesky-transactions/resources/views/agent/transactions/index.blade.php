...
@section('page-subtitle', 'History of all your recorded transfers')
...
<div class="filters-bar">
    <div class="filter-group filter-group-search">
        ...
        <input type="text" name="search" class="filter-control"
               placeholder="Transaction #, name, phone..." value="{{ request('search') }}">
    </div>
...
<div class="table-card animate-on-scroll">
    <div class="table-header">
        <div class="table-title">My transaction history</div>
        <span style="color:var(--text-muted); font-size:13px">{{ $transactions->total() }} result(s)</span>
    </div>
            ...
            @forelse($transactions as $tx)
                <tr>
                    ...
                    <td class="hide-mobile" style="font-size:12px; color:var(--text-secondary)">
                        {{ ['cash'=>'💵 Cash','mobile_money'=>'📱 Mobile','bank'=>'🏦 Bank'][$tx->payment_method] ?? ucfirst($tx->payment_method) }}
                    </td>
            ...
            @empty
                <tr>
                    <td colspan="12" style="text-align:center; padding:50px; color:var(--text-muted)">
                        ...
                        <div style="font-size:13px">Start by recording your first transaction</div>
